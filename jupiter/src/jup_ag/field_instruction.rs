...
pub mod option_instruction {
        ...
        D: Deserializer<'de>,
    {
        ...
        match value {
            ...
            _ => crate::jup_ag::field_instruction::instruction::deserialize(value)
                .map_err(|e| {
                    serde::de::Error::custom(
                        format!("Error deserialize optional instruction: {e}",),
                    )
                })
                .map(Some),
        }
...
pub mod vec_instruction {
    use {
        crate::jup_ag::field_instruction::instruction,
        serde::{Deserialize, Deserializer},
        solana_sdk::instruction::Instruction,
    };
        ...
        D: Deserializer<'de>,
    {
        ...
        for value in values {
            let instruction: Instruction = instruction::deserialize(value).map_err(|e| {
